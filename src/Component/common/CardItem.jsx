...
export const CardItem = ({
  title = "ㅁ자신의 가치과 또는 인생관에 영향을 미친 경험을 소개하고, 이를 통해 배우거나 느낀 점을 구체적으로 기술하시오.",
  ...
  // 텍스트가 100자를 넘으면 잘라서 표시
  const truncatedText =
    text.length > 200 ? text.substring(0, 50) + "..." : text;

  // 태그 표시 개수를 10개로 제한하고 그 뒤에 "..."을 추가
  const displayedTags =
      ...
      >
        ...
        <Box
          sx={{
            display: "flex",
            marginTop: "10px",
            flexWrap: "wrap", // 자식 요소가 여러 줄로 배치되도록 설정
          }}
        >
          {/* 최대 10개의 태그만 표시하고 그 뒤에 ... */}
